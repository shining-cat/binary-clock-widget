...
private class FakeWeatherCache : WeatherCache {
    ...
    override suspend fun write(snapshot: WeatherSnapshot) { stored = snapshot }
}
...
class WeatherRepositoryTest {
  ...
  @Test fun `refresh fetches, caches, returns`() = runTest {
  ...
  @Test fun `cached returns last written`() = runTest {
